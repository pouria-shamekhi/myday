...
class calend(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        self.month.setStyleSheet("font: bold 16px; color: white;background-color: gray")
        ...
        for i in range(6):
            for j in range(7):
                ...
                day_b.setStyleSheet("border-radius: 20px; background-color: lightgray; color: black;")
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.date_label.setStyleSheet("font: 81 10pt \"JetBrains Mono ExtraBold\"; color: rgb(0, 0, 0); background-color: none;")
        ...
        self.jam_shavande.setStyleSheet("background: none; border: none; color: black;")
        self.jam_shavande.clicked.connect(self.blue_line)

        self.listWidget = QtWidgets.QListWidget(Form)
        self.listWidget.setGeometry(QtCore.QRect(400, 110, 661, 511))
        self.listWidget.setStyleSheet("color: black; font: 81 10pt \"JetBrains Mono\"; background-color: white; border: none; padding: 10px;")
        ...
        self.todo_input.setStyleSheet("color: black; font: 81 10pt \"JetBrains Mono\"; background-color: white; border: 1px solid gray;")
        ...
        self.settingsb.setStyleSheet("font: 81 10pt \"JetBrains Mono\"; color: black; background-color: white; border-radius: 10px;")
        ...
        self.music.setStyleSheet("background-color: lightblue; border-radius: 10px;")

        music_layout = QtWidgets.QVBoxLayout(self.music)

        self.song_label = QtWidgets.QLabel("No Song Playing")
        self.song_label.setStyleSheet("font: bold 12pt 'JetBrains Mono'; color: black;")
    ...
    def newitem(self, text, checked=False):
        ...
        removeb.setStyleSheet("background: lightblue; border: none; color: black; margin-left: 10px;")
